...
logging.basicConfig(filename="logs/main.log", format=message_format, datefmt=date_strftime_format, encoding="UTF-8",
                    level=logging.DEBUG)
...
while True:
    ...
    try:
        ...
        continue
    try:
        flag in [1, 2, 3, 4, 5, 6, 7, 8]
    except ValueError as e:
        logging.error(e)
        print("You must to type a number between 1 and 8")
        continue
    ...
    if flag == 1:
        ...
        try:
            ...
            logging.error(e)
            print('You need to write a id of existing plant')
            continue
        ...
        try:
            ...
            logging.error(e)
            print("You must to type id of plant")
            continue
        Plant.delete(id)
    elif flag == 5:
        ...
        try:
            ...
            logging.error(e)
            print("You must to type a number of plant id")
            continue
        ...
        try:
            ...
            print("Please enter id of employee")
            continue
        try:
            ...
            logging.error(e)
            print('You need to write a id of existing employee')
            continue
        ...
        try:
            ...
            logging.error("Id of employee not a number")
            print("You need to type a number of employee")
            continue
        Employee.delete(id)
